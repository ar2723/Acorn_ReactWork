// src/component/FriendComponent.js

import { Component } from "react"

class FriendComponent extends Component{
    render(){
        //부모 component에서 전달된 props 얻어내서 사용하기
            ...
            return(
                <li key={index}>
                    ...
                    <button onClick={()=>{
                        ...
                        //부모 component로부터 전달받은 함수 호출하면서 object 전달하기
                        this.props.updateAction({index, newName});
                    }}>수정</button>
                    <button onClick={()=>{
                        //부모 component로 부터 전달받은 함수 호출하면서 number 전달하기
        ...
        //얻어낸 jsx 배열을 ul의 자식요소에 추가해서 리턴한다.
        return (
            <ul>
                {jsxList}
            </ul>
